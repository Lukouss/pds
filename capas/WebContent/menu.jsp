                ...
                <div class="navbar-header">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                          <ul class="nav navbar-nav">
							  <li role="presentation"><a href="editar.jsp">editar contacto</a></li>
							  <li role="presentation"><a href="editarU.jsp">editar usuario</a></li>
							  <li role="presentation"><a href="eliminar.jsp">eliminar</a></li>
