...
public class ContactoDAO {
	...
	public static boolean save(orm.Contacto contacto) throws PersistentException {
		try {
			orm.EjercicioPersistentManager.instance().saveObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Contacto contacto) throws PersistentException {
		try {
			orm.EjercicioPersistentManager.instance().deleteObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Contacto contacto)throws PersistentException {
		try {
			if(contacto.getEmpresau() != null) {
				contacto.getEmpresau().entidad.remove(contacto);
			}
	...
	public static boolean refresh(orm.Contacto contacto) throws PersistentException {
		try {
			orm.EjercicioPersistentManager.instance().getSession().refresh(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Contacto contacto) throws PersistentException {
		try {
			orm.EjercicioPersistentManager.instance().getSession().evict(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
